...
public class TypeOutEditor : Editor {  
   ...
   // public float timeAmount = 0f;
	...
	public void OnEnable()
	{
      ...
      //  waitTime = TOS.FindProperty("waitTime");
	}
...
//		GUI.Label(new Rect(0, 40, 100, 40), GUI.tooltip);
     ...
     //   EditorGUILayout.LabelField("WaitTime");
       // EditorGUILayout.EndHorizontal();

     //   EditorGUILayout.Space();


     //   timeAmount = EditorGUILayout.Slider(timeAmount, 0f, 10f);
      //  waitTime.floatValue = timeAmount;
